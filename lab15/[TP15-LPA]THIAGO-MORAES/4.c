...
long int soma = 0;
int K=0,N=0; //onde k é quantidade de threads e N o tamanho do vetor
int* vetor; //vetor que receberá os valores aleatórios
...
void *somavet(Controle_Threads *vet){ // metodo para somar os valores das k partes
	int i;
